...
func main() {
	...
	allSchema := schemaCmd.Bool("all", false, "Get all projects")
	idSchema := schemaCmd.String("id", "", "Mason Project ID")
	pathSchemaJson := schemaCmd.String("path", "", "Relative file path of JSON for project create/update")
	...
	case "project": // if its the 'project' command
		handleProject(projectCmd, actionProject, allProject, idProject, pathProjectJson)
	case "schema": // if its the 'schema' command
		handleSchema(schemaCmd, actionSchema, allSchema, idSchema, pathSchemaJson)
	case "content": // if its the 'content' command
		handleContent(contentCmd, actionContent, allContent, idContent)
...
func handleProject(projectCmd *flag.FlagSet, action *string, all *bool, projectId *string, contentPath *string) {
...
func handleSchema(schemaCmd *flag.FlagSet, action *string, all *bool, schemaId *string, contentPath *string) {
...
func handleContent(contentCmd *flag.FlagSet, action *string, all *bool, contentId *string) {
